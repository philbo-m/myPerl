...
#		--- Collapse targets ---
		...
		T_HI_DARK_DARK_INTL			=> { ACT => 0.0010 , PSV => 0.0000 } ,
		T_HI_DARK_DARK_ETF			=> { ACT => 0.0010 , PSV => 0.0000 } ,
		T_HI_DARK_DARK_ETF_INTL		=> { ACT => 0.0010 , PSV => 0.0000 } ,
...
our %collapseMap = (
	NEW => {
		T_HI_DARK_DARK			=> [ qw ( T_HI_PEG_IOC_DARK ) ] ,
		T_HI_DARK_DARK_INTL		=> [ qw ( T_HI_PEG_IOC_DARK_INTL ) ] ,
		T_HI_DARK_DARK_ETF		=> [ qw ( T_HI_PEG_IOC_DARK_ETF ) ] ,
		T_HI_DARK_DARK_ETF_INTL	=> [ qw ( T_HI_PEG_IOC_DARK_ETF_INTL ) ] ,
